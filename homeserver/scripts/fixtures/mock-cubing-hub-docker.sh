...
case "${command_name}" in
  ...
  compose)
    ...
    if [[ "${arguments}" == *" --format json "* ]]; then
      ...
      flyway_enabled="${FAKE_RENDER_FLYWAY_ENABLED:-true}"
