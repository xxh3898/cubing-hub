...
@Getter
public class PublicFeedbackDetailResponse {
    ...
    public PublicFeedbackDetailResponse(
            Long id,
            FeedbackType type,
            String title,
            String content,
    ...
    public static PublicFeedbackDetailResponse from(Feedback feedback) {
        return new PublicFeedbackDetailResponse(
                feedback.getId(),
                feedback.getType(),
                feedback.getTitle(),
                feedback.getContent(),
