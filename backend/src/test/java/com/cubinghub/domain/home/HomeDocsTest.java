        ...
        mockMvc.perform(get("/api/home")
                ...
                .andDo(document("home/get",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("data.todayScramble").type(JsonFieldType.OBJECT).description("서울 날짜 기준으로 고정된 오늘의 스크램블"),
                                fieldWithPath("data.todayScramble.eventType").type(JsonFieldType.STRING).description("스크램블 종목 코드"),
                                fieldWithPath("data.todayScramble.scramble").type(JsonFieldType.STRING).description("해당 날짜에 고정된 스크램블 문자열"),
