...
class FeedbackServiceTest {
    ...
    void should_save_feedback_with_user_when_email_exists() {
        ...
        Long feedbackId = feedbackService.createFeedback(user.getEmail(), request);

        assertThat(feedbackId).isEqualTo(2L);
