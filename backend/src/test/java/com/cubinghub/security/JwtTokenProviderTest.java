...
class JwtTokenProviderTest {
    ...
    void should_extract_email_when_access_token_is_generated() {
        // when
    ...
    void should_extract_authorities_when_access_token_is_generated() {
        // when
        String token = jwtTokenProvider.generateAccessToken(userDetails);
    ...
    void should_return_false_when_access_token_is_expired() {
        // given
    ...
    void should_return_false_when_access_token_is_tampered() {
        // given
        String token = jwtTokenProvider.generateAccessToken(userDetails);
    ...
    void should_extract_email_when_refresh_token_is_generated() {
        // when
        String refreshToken = jwtTokenProvider.generateRefreshToken("test@test.com");
    ...
    void should_return_refresh_token_expiration_when_requested() {
    ...
    void should_return_remaining_expiration_when_token_is_generated() {
        // when
        String token = jwtTokenProvider.generateAccessToken(userDetails);
