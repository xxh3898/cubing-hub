...
> 정식 설계 문서는 [README](../README.md), [Project Overview](../legacy-docs/project-overview.md), [System Architecture](../legacy-docs/system-architecture.md), [Deployment & Infrastructure Design](../legacy-docs/deployment-and-infrastructure-design.md)를 참고하세요.
