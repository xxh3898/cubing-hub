...
const genericCases = [
  ...
  },
  {
    ...
    expectedCallArgs: ['/api/users/me/growth', { params: { eventType: 'WCA_333' } }],
    errorFactory: () => createResponseError('성장 요약 조회 실패'),
    expectedErrorMessage: '성장 요약 조회 실패',
  },
  {
    name: 'getMyGrowthTrend',
    fn: getMyGrowthTrend,
    method: 'get',
    args: [{ eventType: 'WCA_333', period: '30D' }],
    expectedCallArgs: ['/api/users/me/growth/trend', { params: { eventType: 'WCA_333', period: '30D' } }],
    errorFactory: () => createResponseError('성장 추세 조회 실패'),
    expectedErrorMessage: '성장 추세 조회 실패',
  },
  {
    name: 'getMyGrowthPbProgression',
    fn: getMyGrowthPbProgression,
    method: 'get',
    args: [{ eventType: 'WCA_333', page: 1, size: 50 }],
    expectedCallArgs: ['/api/users/me/growth/pb-progression', { params: { eventType: 'WCA_333', page: 1, size: 50 } }],
    errorFactory: () => createResponseError('PB 진행 조회 실패'),
    expectedErrorMessage: 'PB 진행 조회 실패',
  },
  {
